...
[![Build Status](https://builds.gbif.org/job/hp-observatorio-aguas-amazonicas/badge/icon)](https://builds.gbif.org/job/hp-observatorio-aguas-amazonicas/lastBuild/console)
...
# GBIF Hosted Portal: observatorio-aguas-amazonicas

This Jekyll website, **[observatorio-aguas-amazonicas (Staging)](https://observatorio-aguas-amazonicas.hp.gbif-staging.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
